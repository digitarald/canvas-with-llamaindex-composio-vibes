import { AgentState, CardType, ChartData, EntityData, ItemData, NoteData, ProjectData, InvestorData, UpdateData, FeedbackData, MilestoneData } from "@/lib/canvas/types";
